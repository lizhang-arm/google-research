...
#define SCANN_SVE __attribute__((target("+sve")))
#else
#define SCANN_SVE
#endif
...
#define SCANN_SVE_INLINE SCANN_SVE SCANN_INLINE
#define SCANN_SVE_INLINE_LAMBDA SCANN_SVE SCANN_INLINE_LAMBDA
#define SCANN_SVE_OUTLINE SCANN_SVE SCANN_OUTLINE
